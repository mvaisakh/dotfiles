...
case $release in 
	"Arch Linux"|"Artix Linux"|"Manjaro Linux")
		...
		packages="adwaita-icon-theme bdf-unifont feh gnome-themes-extra i3-gaps lxappearance noto-fonts otf-font-awesome papirus-icon-theme picom playerctl ponymix pulseaudio rofi rxvt-unicode scrot urxvt-perls xorg-xbacklight"
